...
// Explicit instantiations for the three miniTPC plane tags so other
// translation units (tools/run_mini_main.cpp) can resolve the template
// member functions. Added locally; the rest of this file is upstream-verbatim.
template int cleanUVW::substractBl<cleanUVW::miniPlaneInfoU>(bool);
template int cleanUVW::substractBl<cleanUVW::miniPlaneInfoV>(bool);
template int cleanUVW::substractBl<cleanUVW::miniPlaneInfoW>(bool);
